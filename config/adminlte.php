        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.1.0/js/buttons.print.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/searchbuilder/1.3.0/js/dataTables.searchBuilder.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/buttons/2.1.0/css/buttons.dataTables.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/searchbuilder/1.3.0/css/searchBuilder.dataTables.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
